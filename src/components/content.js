  ...
  return (
    <div className='max-h-full overflow-y-auto px-12 py-6 mt-10'>
      ...
      <div class='flex mb-16 mt-4'>
        ...
        ></Card>
        <Card
          className='w-1/4 xl:w-1/6 mr-4 hidden xl:block'
          title='El Programa de los Simios'
          subtitle='Desde las entrañas del universo geek para el mundo: El Programa de los Simios...'
        ></Card>
        <Card
          className='w-1/4 xl:w-1/6 hidden xl:block'
          title='El Programa de los Simios'
          subtitle='Desde las entrañas del universo geek para el mundo: El Programa de los Simios...'
        ></Card>
      </div>
      ...
      <Heading
        ...
        subtitle="The music you're had on repeat this month."
      />
      <div class='flex mb-16 mt-4'>
        <Card
          className='w-1/4 xl:w-1/6 mr-4'
      ...
      <Heading
        ...
        subtitle='Brand new music from artists you love.'
      />
      <div class='flex mb-16 mt-4'>
        <Card
          className='w-1/4 xl:w-1/6 mr-4'
