...
function MusicPlayer() {
  return (
    <div className='flex h-full items-center justify-between'>
      <div className='h-full text-gray-700 text-center px-4 py-4 w-1/3 lg:w-1/4 mr-2'>
      ...
      <div className='flex flex-wrap h-full text-center px-4 py-2 w-1/3 lg:w-2/4 mr-2 text-gray-400'>
        <div className='flex flex-wrap items-center justify-center text-center w-full h-auto'>
          <svg className="fill-current h-3 w-3 mr-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <svg className="fill-current h-4 w-4 mr-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <svg className="fill-current h-8 w-8 mr-6 text-gray-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <svg className="fill-current h-3 w-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div className='flex flex-wrap items-center w-full h-auto'>
          <span className="w-2/12 text-right text-sm lg:text-base pr-2 lg:pr-4">0:00</span>
          <div className='h-1 w-8/12 bg-gray-600 rounded-lg'></div>
          <span className="w-2/12 text-left text-sm lg:text-base pl-2 lg:pl-4">110:28</span>
        </div>
      </div>
      <div className='h-full text-gray-700 text-center px-6 py-2 w-1/3 lg:w-1/4'>
        <div className='flex justify-end items-center h-full text-gray-200'>
          ...
          <svg className="fill-current h-5 w-5 lg:h-6 lg:w-6 mr-3 lg:mr-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path fill="none" d="M0 0h24v24H0V0z"/>
            <path d="M4 10h12v2H4zm0-4h12v2H4zm0 8h8v2H4zm10 0v6l5-3z"/>
          </svg>
          <svg className="fill-current h-4 w-4 lg:h-5 lg:w-5 mr-3 lg:mr-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path d="M0 0h24v24H0z" fill="none"/>
            <path d="M4 6h18V4H4c-1.1 0-2 .9-2 2v11H0v3h14v-3H4V6zm19 2h-6c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h6c.55 0 1-.45 1-1V9c0-.55-.45-1-1-1zm-1 9h-4v-7h4v7z"/>
          </svg>
          <svg className="fill-current h-5 w-5 lg:h-6 lg:w-6 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
